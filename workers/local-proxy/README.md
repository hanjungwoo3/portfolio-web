...
> ### 🧩 대신 [크롬 확장](../../extension/README.md)을 권합니다
>
> 확장이 이 문서의 역할을 그대로 하면서 더 간편합니다. **Node 설치도, 터미널도,
> 서버를 켜두는 것도 필요 없습니다.** 게다가 앱을 팝업으로 띄워줘서 주소를 칠 필요도 없습니다.
>
> | | 로컬 프록시(이 문서) | 크롬 확장 |
> |---|---|---|
> | 준비 | Node 설치 + 파일 받기 + 터미널 | 확장 설치 1회 |
> | 실행 유지 | 터미널을 켜두어야 함 | 브라우저만 |
> | 앱 접속 | 주소 직접 입력 | 툴바 아이콘 클릭 |
> | 브라우저 | 크롬·엣지·파이어폭스 | 크롬·엣지 |
>
> 파이어폭스를 쓰거나 확장을 설치하고 싶지 않은 경우에만 아래 방법을 쓰세요.
