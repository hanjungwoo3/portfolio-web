...
- **Yahoo 도 통과한다** — 실측(2026-09-08, 안드로이드 실기기) 102 건 200, 401·예외 0 건.
  crumb 이 필요한 v7/quote·quoteSummary 는 nativeProxy 가 확장과 같은 방식으로 crumb 을
  발급해 붙인다(쿠키는 CapacitorCookies 가 유지). 남은 404 4 건은 Yahoo 에 아예 없는
  심볼(V-KOSPI·^US2Y·코스피200선물·코스닥150선물)로, 각각 다른 소스 폴백이 있다.
